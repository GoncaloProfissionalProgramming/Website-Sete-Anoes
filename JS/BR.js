        ...
        function changeImageBackBR(){
          ...
          if(counterback==7){
             ...
             document.getElementById("nome").innerHTML = "Dunga";
             counterback=4;
             counternext=6;
             ...
             document.getElementById("nome").innerHTML = "Dengoso";
             counterback=1;
             counternext=3;
          }else {
             document.img.src="1Doc.png";
             document.getElementById("nome").innerHTML = "Mestre";
             counterback=7;
             counternext=2;
          }
